...
document.addEventListener('mousemove', function(e){
  ...
  //if(mouseIsDown) {
    ...
    if(mouse.y > 0) {
      var clouds = document.getElementsByclass("cloud");
      for(var i=0; i<clouds.length; i++) {
        clouds[i].style.left = Math.min(myWidth*(Math.pow(mouse.y,2)/Math.pow(myHeight/2,2)) * -1, 0);
      }
    //}

    var stars = document.getElementsByclass('star');
...
document.getElementById("waterDistance").style.height = myHeight - skyHeight;
 document.getElementById("division").style.top = skyHeight;
  ...
  return (
    <div style={{"width":"100%","height":"100%","margin":"0","padding":"0"}} onmouseup="stopMove();" onresize="windowResize();">
    ...
    <div className="star" style={{"left":"250px","top":"30px"}} />
    <div className="star" style={{"left":"300px","top":"25px"}} />
    <div className="star" style={{"right":"40px","top":"40px"}} />
    <div className="star" style={{"right":"80px","top":"45px"}} />
    <div className="star" style={{"right":"120px","top":"20px"}} />
    <div id="horizon" onmousedown="startMove();" onmouseup="stopMove();" />
    <div id="horizonNight" onmousedown="startMove();" onmouseup="stopMove();" />
    <div id="moon" onmousedown="startMove();" onmouseup="stopMove();" />
    ...
    <div id="water" onmousedown="startMove();" onmouseup="stopMove();" />
    ...
    <div id="waterDistance" onmousedown="startMove();" onmouseup="stopMove();" />
    <div id="darknessOverlaySky" onmousedown="startMove();" onmouseup="stopMove();" />
    <div id="darknessOverlay" />
